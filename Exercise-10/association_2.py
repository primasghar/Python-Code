...
# of the bottom and top floors and the number of elevators in the building.
# When a building is created, the building creates the required no of elevators. The list of elevators is stored as a property of the building.
